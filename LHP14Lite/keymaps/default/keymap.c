...
/* [SAM] = LAYOUT( \
    ...
    TO(SCH),  KC_3,     KC_5,       KC_6,     KC_7,         JS_BUTTON7 \
  ),*/
  ...
  [SCH] = LAYOUT( \
    ...
    TO(DRG),   XXXXXXX,    KC_S,       KC_7,       SR_CS,         JS_BUTTON7 \
  ),

  /* DRG
   * ,----------------------------------.   
   * |∫›act1|  W   |ƒ©Ÿ∞N |Ω ﬂ≤›D|  D   |   
   * |------+------+------+------+------|   
   * |   A  |Space |¿πﬁë÷ |¿πﬁãﬂ |ºﬁ¨›Ãﬂ|   
   * |------+------+------+------+------|   
   * |ó≥í‹îˆ|ëìó≥åå|±—⁄›  |D¿ﬁ≤Ãﬁ| ñÚ1  |   
   * |------+------+------+------+------|   
   * |DRK   |      |   S  |≤Ÿ∞ºÃﬁ|ÿ¿∆∞  |   
   * `----------------------------------'   
   */
  ...
  [DRK] = LAYOUT( \
    ...
    TO(WAR),     XXXXXXX,      XXXXXXX,    LALT(KC_4), XXXXXXX,     JS_BUTTON7 \
  ),
  ...
  [WAR] = LAYOUT( \
    ...
    TO(DNC),     XXXXXXX,      XXXXXXX,    LALT(KC_1), XXXXXXX,     JS_BUTTON7 \
  ),
  ...
  [DNC] = LAYOUT( \
    ...
    TO(WHM),  XXXXXXX,   XXXXXXX,    KC_ASTR,   KC_MINUS,     JS_BUTTON7 \
  ),

  /* WHM
   * ,----------------------------------.   
   * |∫›act1|   W  |Õﬁ∆ø›T|√› ﬂ  |ã~èo  |   
   * |------+------+------+------+------|   
   * |      |Space |¿πﬁë÷ |¿πﬁãﬂ |Ÿ∞ºØƒﬁ|   
   * |------+------+------+------+------|   
   * |      |º›¥±∞ |åòé¿ñÇ|ê_ë¨ñÇ|      |   
  ...
  [WHM] = LAYOUT( \
    ...
    TO(RDM),    XXXXXXX,    XXXXXXX,       LALT(KC_7),    XXXXXXX,      JS_BUTTON7 \
  ),
  ...
  [RDM] = LAYOUT( \
    ...
    TO(NIN),     XXXXXXX,    XXXXXXX,    XXXXXXX,    KC_Z,          JS_BUTTON7 \
  ),
  ...
  [NIN] = LAYOUT( \
    ...
    TO(RGB),   XXXXXXX,    XXXXXXX,    KC_9,       XXXXXXX,       JS_BUTTON7 \
  ),
